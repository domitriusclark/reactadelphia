...
export async function getGuild() {
  try {
    const res = await fetch(
      `https://discord.com/api/v9/guilds/${process.env.DISCORD_GUILD_ID}`,
      {
        headers: {
          Authorization: `Bot ${process.env.DISCORD_BOT_TOKEN}`,
        },
...
export async function getGuildActiveThreads(
  ...
  try {
    const response = await fetch(
      `https://discord.com/api/v9/guilds/${process.env.DISCORD_GUILD_ID}/threads/active`,
      {
        headers: {
          Authorization: `Bot ${process.env.DISCORD_BOT_TOKEN}`,
        },
...
export async function getGuildChannels() {
  try {
    const response = await fetch(
      `https://discord.com/api/v9/guilds/${process.env.DISCORD_GUILD_ID}/channels`,
      {
        headers: {
          Authorization: `Bot ${process.env.DISCORD_BOT_TOKEN}`,
        },
